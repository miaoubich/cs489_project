...
public class VideoCopyController {
	...
	@PutMapping("/{id}")
	public ResponseEntity<VideoCopyResponse> updateCustomer(@PathVariable(name = "id") Long id,
			@RequestBody VideoCopyRequest videoCopyRequest) {
